...
import {
    ...
    HI3CharactersToJSON,
    Hi3CharactersControllerGetOneRequestFromJSON,
    Hi3CharactersControllerGetOneRequestToJSON,
...
export interface Hi3CharactersControllerGetOneOperationRequest {
    Hi3CharactersControllerGetOneRequest: Hi3CharactersControllerGetOneRequest;
}
...
export interface Hi3CharactersApiInterface {
    ...
    /**
     * 
     * @param {Hi3CharactersControllerGetOneRequest} Hi3CharactersControllerGetOneRequest 
     * @param {*} [options] Override http request option.
     * @throws {RequiredError}
     * @memberof Hi3CharactersApiInterface
     */
    hi3CharactersControllerGetOneRaw(requestParameters: Hi3CharactersControllerGetOneOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HI3Characters>>;

    /**
     */
    hi3CharactersControllerGetOne(Hi3CharactersControllerGetOneRequest: Hi3CharactersControllerGetOneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HI3Characters>;
...
export class Hi3CharactersApi extends runtime.BaseAPI implements Hi3CharactersApiInterface {
    ...
    /**
     */
    async hi3CharactersControllerGetOneRaw(requestParameters: Hi3CharactersControllerGetOneOperationRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<HI3Characters>> {
        if (requestParameters['Hi3CharactersControllerGetOneRequest'] == null) {
            throw new runtime.RequiredError(
                'Hi3CharactersControllerGetOneRequest',
                'Required parameter "Hi3CharactersControllerGetOneRequest" was null or undefined when calling hi3CharactersControllerGetOne().'
            );
        }
        ...
        const response = await this.request({
            ...
            headers: headerParameters,
            query: queryParameters,
            body: Hi3CharactersControllerGetOneRequestToJSON(requestParameters['Hi3CharactersControllerGetOneRequest']),
        }, initOverrides);
    ...
    /**
     */
    async hi3CharactersControllerGetOne(Hi3CharactersControllerGetOneRequest: Hi3CharactersControllerGetOneRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<HI3Characters> {
        const response = await this.hi3CharactersControllerGetOneRaw({ Hi3CharactersControllerGetOneRequest: Hi3CharactersControllerGetOneRequest }, initOverrides);
        return await response.value();
    }
